...
FLOW_SENSOR_STATE_T flow_sensor_state = {
    .dp_id_flow_value = DP_ID_FLOW_VALUE,
    .flow_value = 0,
};
...
VOID_T hw_report_all_dp_status(VOID_T)
{
    ...
    /*  */
    dp_arr[0].dpid = flow_sensor_state.dp_id_flow_value;
    dp_arr[0].type = PROP_VALUE;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = flow_sensor_state.flow_value;
